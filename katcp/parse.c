...
#define STATE_FRESH      0  /* newly allocated or cleared */

#define STATE_COMMAND    1  /* busy being parsed */
#define STATE_WHITESPACE 2 
#define STATE_ARG        3
#define STATE_TAG        4
#define STATE_ESCAPE     5

#define STATE_FAKE       6  /* busy being generated by hand */

#define STATE_DONE       7  /* a complete message in unflat form */
#define STATE_FLAT       8  /* a complete message in flat form */
...
void clear_parse_katcl(struct katcl_parse *p)
{
  ...
  /* WARNING: won't clear trailing p_next */
}
...
int parse_katcl(struct katcl_line *l) /* transform buffer -> args */
{
  ...
  while((p->p_used < p->p_have) && (p->p_state != STATE_DONE)){
    ...
    switch(p->p_state){
      ...
      case STATE_FLAT :
#ifdef DEBUG
        fprintf(stderr, "major logic problem: attempting to re-parse a flattened message\n");
        abort();
#endif
        break;
